...
router.post('/generate-link', (req, res) => {
  ...
  const message = `🎅 *Amigão* 🎁%0A%0AOlá ${from}!%0A%0AO teu amigão é: *${to}*%0A%0AValor máximo: ${maxValue || 'Sem limite'} €%0ANão sejas forreta ${from}!!!%0A%0A----%0A*Amigão* v1.2.11%0ADesenvolvido por Jaime Soares Mascarenhas%0AData: ${today}%0A© 2025%0A%0AVê o teu resultado aqui:%0Ahttps://amigao.onrender.com/%0A%0ABoa sorte! 🎉`;
